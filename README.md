...
#### 方式二：使用 Docker Hub 预构建镜像 (最简单)

这种方式无需在本地构建镜像，可以直接使用我们为你准备好的最新版本。
...
2.  **拉取最新镜像**:
    ```bash
    docker pull luohang2333/job-agent:latest
    ```
